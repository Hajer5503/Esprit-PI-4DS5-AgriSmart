                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 4),
                            Text(
                              'Arabic voice assistant • Offline Qwen',
                              style: TextStyle(
...
class _ResultScreenState extends State<ResultScreen> {
  ...
  Future<void> _runInference() async {
    try {
      ...
      debugPrint('[AgriSmart] Input  shape: $inShape  type: ${inputTensor.type}');
      debugPrint('[AgriSmart] Output shape: $outShape type: ${outputTensor.type}');
